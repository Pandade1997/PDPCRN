...
from networks.DPCRN import DPCRN_NET
...
parser.add_argument('--mic_dir', type=str,
                    default='/ddnstor/imu_panjiahui/dataset/SHdomainNew/RIR/cir_uniform_16/train_val_rir/MIC')
...
parser.add_argument('--num_worker', type=int, default=16, help='Num_workers: if on PC, set 0')
