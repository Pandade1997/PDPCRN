...
class GCRN(nn.Module):
    def __init__(self, in_ch=16, out_ch=1):
        ...
        self.conv2_t_1 = GluConvTranspose2d(in_channels=64, out_channels=16, kernel_size=(1, 3), stride=(1, 2),
                                            output_padding=(0, 1))
        self.conv1_t_1 = GluConvTranspose2d(in_channels=32, out_channels=out_ch, kernel_size=(1, 3), stride=(1, 2))
        ...
        self.conv2_t_2 = GluConvTranspose2d(in_channels=64, out_channels=16, kernel_size=(1, 3), stride=(1, 2),
                                            output_padding=(0, 1))
        self.conv1_t_2 = GluConvTranspose2d(in_channels=32, out_channels=out_ch, kernel_size=(1, 3), stride=(1, 2))
        ...
        self.bn1_t_1 = nn.BatchNorm2d(out_ch)
        ...
        self.bn1_t_2 = nn.BatchNorm2d(out_ch)
