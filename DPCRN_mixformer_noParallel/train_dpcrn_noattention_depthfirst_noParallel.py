...
from networks.DPCMN_mixformer_noattention_depthwisefirst_noParallel import DPCMN_mixformer
...
if __name__ == "__main__":
    ...
    if resume:
        modelpath = 'model_dpcrn_mixformer_noattention_depthfirst_noParallel/'
