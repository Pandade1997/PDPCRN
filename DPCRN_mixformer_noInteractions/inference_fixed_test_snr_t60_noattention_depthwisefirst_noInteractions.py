...
from networks.DPCMN_mixformer_noattention_depthwisefirst import DPCMN_mixformer
from networks.DPCMN_mixformer_noattention_depthwisefirst_noInteractions import DPCMN_mixformer
import warnings
...
if __name__ == "__main__":
    modelpath = 'model_dpcrn_mixformer_noattention_depthfirst_noInteractions/'
    test_list = [
